...
func (ac *AccountCreate) SetGoogleUserID(s string) *AccountCreate {
	ac.mutation.SetGoogleUserID(s)
	return ac
}
...
func (ac *AccountCreate) check() error {
	...
	if _, ok := ac.mutation.GoogleUserID(); !ok {
		return &ValidationError{Name: "google_user_id", err: errors.New(`ent: missing required field "Account.google_user_id"`)}
	}
	if v, ok := ac.mutation.GoogleUserID(); ok {
...
func (ac *AccountCreate) createSpec() (*Account, *sqlgraph.CreateSpec) {
	...
	if value, ok := ac.mutation.GoogleUserID(); ok {
		_spec.SetField(account.FieldGoogleUserID, field.TypeString, value)
		_node.GoogleUserID = value
	}
