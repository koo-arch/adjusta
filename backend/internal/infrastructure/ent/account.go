...
type Account struct {
	...
	// GoogleUserID holds the value of the "google_user_id" field.
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case account.FieldGoogleUserID, account.FieldAccessToken, account.FieldRefreshToken, account.FieldScope:
			values[i] = new(sql.NullString)
		case account.FieldCreatedAt, account.FieldUpdatedAt, account.FieldExpiresAt:
	...
	for i := range columns {
		...
		case account.FieldGoogleUserID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field google_user_id", values[i])
			} else if value.Valid {
				a.GoogleUserID = value.String
			}
...
func (a *Account) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("google_user_id=")
	builder.WriteString(a.GoogleUserID)
	builder.WriteString(", ")
